...
export const metadata: Metadata = {
  title: 'FAQs | Rebound Capital Group',
  description: 'Frequently asked questions about surplus fund recovery.',
}
    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '80px 24px' }}>
      <div style={{ maxWidth: '560px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '15px', color: '#7a90c0', lineHeight: 1.75, marginBottom: '8px' }}>
          Our full FAQ page is being built. In the meantime call us directly — our team answers every question personally with no pressure and no obligation.
        </p>
