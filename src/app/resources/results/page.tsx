...
export const metadata: Metadata = {
  title: 'Client Results | Rebound Capital Group',
  description: 'Real results from RCG surplus fund recoveries.',
}
    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '80px 24px' }}>
      <div style={{ maxWidth: '560px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '15px', color: '#7a90c0', lineHeight: 1.75, marginBottom: '8px' }}>
          We are compiling documented recovery results from our clients. Call us to speak directly with our team about what we have recovered and how we work.
        </p>
