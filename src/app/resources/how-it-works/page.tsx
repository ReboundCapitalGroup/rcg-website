...
export const metadata: Metadata = {
  title: 'How It Works | Rebound Capital Group',
  description: 'Learn how RCG recovers your surplus funds.',
}
    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '80px 24px' }}>
      <div style={{ maxWidth: '560px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '15px', color: '#7a90c0', lineHeight: 1.75, marginBottom: '8px' }}>
          A full breakdown of our recovery process is coming soon. The short version: we find it, we file it, we recover it. You pay nothing until we do.
        </p>
