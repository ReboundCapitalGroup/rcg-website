...
export const metadata: Metadata = {
  ...
  description: 'Pre-sale foreclosure solutions to preserve equity before the auction — cash offers, mortgage assumptions, and buyer connections from Rebound Capital Group.',
}
